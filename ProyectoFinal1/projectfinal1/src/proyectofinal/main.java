		...
		do {
		  ...
		  switch(option) {
			  ...
			  case 2: {
				  ...
				  System.out.println("1.-) Listar por orden alfabetico de A-Z ");
			      System.out.println("2.-) Listar por orden alfabetico de Z-A");
				  System.out.println("3.-) Listar por nota maxima");
				  System.out.println("4.-) Mostrar solo reprobados");
				  System.out.println("5.-) Mostrar solo aprobados");
				  ...
				  case 2:{
					  ArrayList<Student> list=management.ShowOrderZYX();
					  list.forEach((Student item) -> {
					  System.out.println(item.getId()+ " .-)" + item.getLastname()+ " "+ item.getName()+ " "+
					  item.getEmail()+ " : "+
					  item.getGrade().getP1()+ " | "+
